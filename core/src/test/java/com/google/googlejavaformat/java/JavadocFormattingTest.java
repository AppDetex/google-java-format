...
public final class JavadocFormattingTest {
  ...
  public void oneLinerWouldBe101() {
    String[] input = {
      "/**",
      " * 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 5678901",
      " */",
      "class Test {}",
    };
    String[] expected = {
  ...
  public void multilineWrap() {
    String[] input = {
      "/**",
      " * 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 45678901",
      " */",
      "class Test {}",
    };
    String[] expected = {
  ...
  public void joinedTokens() {
    ...
    String[] input = {
      "/**",
      " * 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 4<b>8901",
      " */",
      "class Test {}",
    };
    String[] expected = {
  ...
  public void joinedAtSign() {
    ...
    String[] input = {
      "/**",
      " * 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 @5678901",
      " */",
      "class Test {}",
    };
    String[] expected = {
  ...
  public void joinedMultipleAtSign() {
    ...
    String[] input = {
      "/**",
      " * 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 @56789012 @5678901",
      " */",
      "class Test {}",
    };
    String[] expected = {
      "/**",
      " * 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012",
  ...
  public void links() {
    String[] input = {
      "/**",
      " * 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 4567 <a",
      " * href=foo>foo</a>.",
      " *",
      " * <p>789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789 <a href=foo>",
      " * foo</a>.",
      " *",
      " * <p>789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 4567890 <a href=foo>",
      " * foo</a>.",
      " *",
      " * <p><a href=foo>",
      " * foo</a>.",
    ...
    String[] expected = {
      ...
      " * href=foo>foo</a>.",
      " *",
      " * <p>789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789 <a href=foo>foo</a>.",
      " *",
      " * <p>789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 456789012 4567890 <a href=foo>",
      " * foo</a>.",
      " *",
  ...
  public void unicodeCharacterCountArguableBug() {
    ...
    String[] input = {
      "/**",
      " * 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞",
      " */",
      "class Test {}",
    };
    String[] expected = {
      "/**",
      " * 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12 456789𝄞12",
      " * 456789𝄞12 456789𝄞",
      " */",
      "class Test {}",
    };
  ...
  public void paramsContinuationIndented() {
    String[] input = {
      ...
      " * hello world",
      " *",
      " * @param foo 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123",
      " * @param bar another",
      " */",
      "class Test {}",
    };
    String[] expected = {
      ...
      " * hello world",
      " *",
      " * @param foo 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123 567890123",
      " *     567890123",
      " * @param bar another",
      " */",
      "class Test {}",
  ...
  public void javadocFullSentences() {
    ...
    String[] expected = {
      "/**",
      " * In our application, bats are often found hanging from the ceiling, especially on Wednesdays. Sometimes sick bats have issues where their claws do not close",
      " * entirely. This class provides a nice, grippable surface for them to cling to.",
      " */",
      "class Grippable {}",
    };
    doFormatTest(input, expected);
  ...
  public void javadocSentenceFragment() {
    String[] input = {
      "/** Provides a comfy, grippable surface for sick bats with claw-closing problems, which are sometimes found hanging from the ceiling on Wednesday afternoons in odd years. */",
      "class Grippable {}",
    };
    String[] expected = {
      "/**",
      " * Provides a comfy, grippable surface for sick bats with claw-closing problems, which are sometimes found hanging from the ceiling on Wednesday afternoons in",
      " * odd years.",
      " */",
      "class Grippable {}",
    };
